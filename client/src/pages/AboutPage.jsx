export default function AboutPage() {
  return (
    <div className="max-w-3xl mx-auto px-6 py-12">
      ...
      <p className="mb-4 text-gray-800 leading-relaxed">
        This project was built as part of a full-stack development journey using
        the MERN stack (MongoDB, Express, React, and Node.js). It integrates AI
        for data summarization, a secure authentication system, and responsive,
      ...
      <p className="text-gray-600 mt-6 text-sm italic">
        Built with passion and curiosity. Feedback and collaboration are always
        welcome.
      </p>
    </div>
  );
